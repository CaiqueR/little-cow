...
const { Vaquinha, Usuario } = require("../db");
 ...
 */
module.exports.inserir = function (vaquinha) {
...
module.exports.contribuir = function (idVaq, contr) {
  contr.valor *= 1;
  return new Promise((resolve, reject) => {
...
/** Procura vaquinhas */
module.exports.findVaquinhas = function (query) {
  let sort = null;
  if (query.sort) {
    sort = query.sort;
    delete query.sort;
